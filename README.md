...
local Window = OrionLib:MakeWindow({Name = "Dominance Hub", HidePremium = false, IntroText = "Dominance Hub", SaveConfig = true, ConfigFolder = "ConfigSetting"})
